...
#define MOVESPEED_ID_INFECTED_SLOW					"INFECTED_SLOW"
#define MOVESPEED_ID_INFECTED_DAMAGE_SLOW			"INFECTED_DAMAGE_SLOW"
#define MOVESPEED_ID_BRUISER_SLOW					"BRUISER_SLOW"
